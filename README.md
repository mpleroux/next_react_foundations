...
There are notes I took while following the tutorial [React Foundations](https://nextjs.org/learn/react-foundations). I started with an empty directory and created files as instructed. I noticed the tutorial was written for React version 18, not 19, and that introduced some problems later on.
